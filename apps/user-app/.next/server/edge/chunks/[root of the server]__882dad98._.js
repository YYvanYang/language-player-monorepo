(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__882dad98._.js", {
...
"[project]/packages/auth/src/index.ts [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const placeholderAuth = 'auth';
}}),
"[project]/apps/user-app/middleware.ts [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$auth$2f$src$2f$index$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/auth/src/index.ts [middleware-edge] (ecmascript)"); // Use shared config
;
;
;
const sessionOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$auth$2f$src$2f$index$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getUserSessionOptions"])();
const config = {
    matcher: [
        /*
...
async function middleware(request) {
    ...
    try {
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$iron$2d$session$40$8$2e$0$2e$4$2f$node_modules$2f$iron$2d$session$2f$dist$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getIronSession"])(request, response, sessionOptions);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__882dad98._.js.map